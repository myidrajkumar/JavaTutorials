...
public class ObjectCreation {
  ...
  public static void main(String... args) throws Exception {
    ...
    Employee classFirstEmployee = (Employee) Class
        .forName("com.rajkumar.java.utils.simpleconcepts.ObjectCreation.Employee").newInstance();  //NOSONAR
  ...
  private static class Employee implements Cloneable, Serializable {
    ...
    public Employee() {
      logger.info("Employee Constructor Called..." + this.getClass().getCanonicalName());
    }
