...
public class EmbeddedMeLink implements TargetDomain {
  ...
  public void setEmbeddedMeLinkReportMyActivity(
      String embeddedMeLinkReportMyActivity) {
  ...
  public void setEmbeddedMeLinkMakeMeAvailable(
      String embeddedMeLinkMakeMeAvailable) {
  ...
  public void setEmbeddedMeLinkCallForwardingSettings(
      String embeddedMeLinkCallForwardingSettings) {
