...
public class EmbeddedCommunicationLink implements TargetDomain {
  ...
  public void setEmbeddedCommunicationLinkSelf(
      String embeddedCommunicationLinkSelf) {
  ...
  public void setEmbeddedCommunicationLinkStartPhoneAudio(
      String embeddedCommunicationLinkStartPhoneAudio) {
  ...
  public void setEmbeddedCommunicationLinkConversations(
      String embeddedCommunicationLinkConversations) {
  ...
  public void setEmbeddedCommunicationLinkStartMessaging(
      String embeddedCommunicationLinkStartMessaging) {
  ...
  public void setEmbeddedCommunicationLinkStartOnlineMeeting(
      String embeddedCommunicationLinkStartOnlineMeeting) {
  ...
  public void setEmbeddedCommunicationLinkJoinOnlineMeeting(
      String embeddedCommunicationLinkJoinOnlineMeeting) {
