...
public class EmbeddedPeopleLink implements TargetDomain {
  ...
  public void setEmbeddedPeopleLinkPresenceSubscriptions(
      String embeddedPeopleLinkPresenceSubscriptions) {
  ...
  public void setEmbeddedPeopleLinkSubscribedContacts(
      String embeddedPeopleLinkSubscribedContacts) {
  ...
  public void setEmbeddedPeopleLinkPresenceSubscriptionMemberships(
      String subscriptionMemberships) {
    
    this.embeddedPeopleLinkPresenceSubscriptionMemberships = subscriptionMemberships;
  }
  ...
  public void setEmbeddedPeopleLinkMyGroupMemberships(
      String embeddedPeopleLinkMyGroupMemberships) {
  ...
  public void setEmbeddedPeopleLinkMyContacts(
      String embeddedPeopleLinkMyContacts) {
  ...
  public void setEmbeddedPeopleLinkMyPrivacyRelationships(
      String embeddedPeopleLinkMyPrivacyRelationships) {
  ...
  public void setEmbeddedPeopleLinkMyContactsAndGroupsSubscription(
      String myContactsAndGroupsSubscription) {
    
    this.embeddedPeopleLinkMyContactsAndGroupsSubscription = myContactsAndGroupsSubscription;
  }
