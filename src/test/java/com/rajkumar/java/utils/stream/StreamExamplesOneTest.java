...
public class StreamExamplesOneTest {
  ...
  public final void testIsMatchAll_Valid() {
    ...
    assertThat("Elements are not matching",
        StreamExamplesOne.isMatchAll(list, predicate), CoreMatchers.is(true));
  ...
  public final void testIsMatchAll_Invalid() {
    ...
    assertThat("Elements are matching",
        StreamExamplesOne.isMatchAll(list, predicate), CoreMatchers.is(false));
    
  }
  
  /**
   * Validating any element.
   */
  @Test
  public final void testIsMatchAny_Valid() {
    ...
    assertThat("No element is matching",
        StreamExamplesOne.isMatchAny(list, predicate), CoreMatchers.is(true));
  ...
  public final void testIsMatchAny_Invalid() {
    ...
    assertThat("Atlease one element is matching",
        StreamExamplesOne.isMatchAny(list, predicate), CoreMatchers.is(false));
    
  }
  
  /**
   * Validating no element.
   */
  @Test
  public final void testIsMatchNone_Valid() {
    ...
    assertThat("Atlease one element is matching",
        StreamExamplesOne.isMatchNone(list, predicate), CoreMatchers.is(true));
  ...
  public final void testIsMatchNone_Invalid() {
    ...
    assertThat("No element is matching",
        StreamExamplesOne.isMatchNone(list, predicate), CoreMatchers.is(false));
  ...
  public final void testGetSum_Integers() {
    ...
    assertThat("Sum is not correct", StreamExamplesOne.getSum(list),
        CoreMatchers.is(10));
    
  }
  
  /**
   * deducting to one element.
   */
  @Test
  ...
  public final void testReduceOperation_InvalidList() {
    ...
    assertThat("This is the smallest country",
        StreamExamplesOne.getSmallestItem(countries), CoreMatchers.nullValue());
  ...
  public final void testParallelStream() {
    ...
    Predicate<Employee> seniorEmp = employee -> employee.salary > 3000
        && employee.salary < 6000;
    
    OptionalDouble averageSalary = employeeList.parallelStream()
        .filter(seniorEmp).mapToDouble(employee -> employee.salary).average();
    
    assertThat("Average is not correct", averageSalary.getAsDouble(),
  ...
  public final void testSequentialStream() {
    ...
    Predicate<Employee> juniorEmp = employee -> employee.salary > 1000
        && employee.salary < 4000;
    
    int salarySum = employeeList.stream().filter(juniorEmp)
        .mapToInt(employee -> employee.salary).sum();
    
    assertThat("Salary sum is not correct", salarySum, CoreMatchers.is(5000));
